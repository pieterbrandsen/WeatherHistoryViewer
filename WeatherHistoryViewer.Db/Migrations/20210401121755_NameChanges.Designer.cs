...
namespace WeatherHistoryViewer.Db.Migrations
{
    ...
    [Migration("20210401121755_NameChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeatherHistoryViewer.Core.Models.DataWarehouse.WeatherMeasurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WeatherHistoryViewer.Core.Models.DataWarehouse.WeatherWarehouse", b =>
                {
                    ...
                    b.HasIndex("DefaultLocationName");
            ...
            modelBuilder.Entity("WeatherHistoryViewer.Core.Models.DataWarehouse.WeatherWarehouse", b =>
                {
                    b.HasOne("WeatherHistoryViewer.Core.Models.DataWarehouse.LocationWarehouse", "Location")
                        .WithMany()
                        .HasForeignKey("DefaultLocationName");

                    b.HasOne("WeatherHistoryViewer.Core.Models.DataWarehouse.Time", "Time")
                        .WithMany()
                        .HasForeignKey("TimeId");

                    b.HasOne("WeatherHistoryViewer.Core.Models.DataWarehouse.WeatherMeasurement", "WeatherMeasurement")
                        .WithMany()
                    ...
                    b.Navigation("WeatherMeasurement");
                });
